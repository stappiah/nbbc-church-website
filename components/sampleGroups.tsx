...
export const sampleGroups: Group[] = [
  {
    id: 1,
    name: "The New Breed Choir (TNBC)",
    tagline: "Lifting Hearts Through Worship.",
    description:
  ...
  {
    id: 2,
    name: "Akwaaba Ministry",
    tagline: "The First Smile You See.",
    description:
  ...
  },
  {
    id: 3,
    name: "Media Team",
    tagline: "Sharing the Message Through Technology.",
    description:
  ...
  {
    id: 4,
    name: "Hallelujah karaara",
    tagline: "Dancers for Christ.",
    description:
  ...
  },
  {
    ...
    tagline: "Powerful Intercession for Our Church.",
    description:
  ...
  {
    id: 6,
    name: "NBBC Film Stars",
    tagline: "Lights, Camera, Faith!",
    description:
  ...
  },
  {
    ...
    description:
      "A dynamic group for teenagers to connect, have fun, and grow in their faith. We have games, worship, and relevant discussions every week.",
    imageUrl:
